...
export function CategoryPreferencesSelector({
    ...
    const handleWantChange = (value: string) => {
        ...
        const newAvoid = value !== NONE_VALUE && preferences.avoid.includes(value)
            ? []
            : preferences.avoid
    ...
    const handleAvoidChange = (value: string) => {
        ...
        const newWant = value !== NONE_VALUE && preferences.want.includes(value)
            ? []
            : preferences.want
        onChange({ want: newWant, avoid: newAvoid })
    }
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
                ...
                <Select value={currentWant} onValueChange={handleWantChange}>
                    <SelectTrigger className="w-full bg-background/50 border-green-500/30 focus:ring-green-500/30">
            ...
            <div className="space-y-2">
                ...
                <Select value={currentAvoid} onValueChange={handleAvoidChange}>
                    <SelectTrigger className="w-full bg-background/50 border-red-500/30 focus:ring-red-500/30">
