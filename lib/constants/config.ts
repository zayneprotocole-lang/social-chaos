...
export const GAME_CONFIG = {
    ...
    COLORS: {
        ...
        PROGRESSIVE: {
            BORDER: '#FF1493',
            BG_GRADIENT: 'linear-gradient(135deg, #FF1493 0%, #FF69B4 25%, #FFB6C1 50%, #FF69B4 75%, #FF1493 100%)',
...
export const DIFFICULTY_CONFIG: Record<DifficultyLevel, { name: string; color: string; timer: number; description?: string; backgroundClass: string }> = {
    1: {
        name: 'Échauffement',
        color: '#39FF14',
        timer: 0,
...
export const CATEGORY_CONFIG: Record<DareCategory, { label: string; color: string }> = {
