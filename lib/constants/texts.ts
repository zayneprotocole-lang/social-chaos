...
export const TEXTS = {
  ...
  lobby: {
    ...
    difficulties: {
      ...
      apocalypse: {
        name: 'Apocalypse',
        description: 'Timer 45s, gages extrêmes',
      },
    },

    timeEstimate: 'Durée estimée',

    // Help bubble texts - Edit these to customize help popups
    help: {
      players: '', // Help text for players section
      options: '', // Help text for options section (tours + alcohol mode)
      categories: '', // Help text for categories section
      difficulty: '', // Help text for difficulty section
    },
  },
  ...
  premium: {
    ...
    benefits: {
      packs: {
        ...
        desc: 'Accès à tous les packs thématiques',
      },
      noAds: {
        title: 'Aucune publicité',
        desc: 'Expérience fluide sans interruption',
      },
      exclusive: {
        title: 'Gages Premium',
        desc: 'Des défis inédits et épicés',
      },
      earlyAccess: {
        title: 'Avant-premières',
        desc: 'Accès anticipé aux nouvelles fonctionnalités',
      },
    },
  },
